...
const SolicitarImagenes = (url) => {
  ...
  .then(res => res.json()) // Convierte la respuesta en objeto de JSON
  .then(data => {
...
SolicitarImagenes(`https://api.pexels.com/v1/search?query=${valueSearch}`);
